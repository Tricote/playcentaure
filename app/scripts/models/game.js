...
define([
    ...
    var Game = Backbone.Model.extend({
        ...
        isMoveAuthorized: function(fromCase, toCase){
          ...
          var horizontal1 = parseInt(toCase.get('i')) === parseInt(fromCase.get('i')) && parseInt(toCase.get('j')) === parseInt(fromCase.get('j') + 3);
          var horizontal2 = parseInt(toCase.get('i')) === parseInt(fromCase.get('i')) && parseInt(toCase.get('j')) === parseInt(fromCase.get('j') - 3);
          var vertical1 = parseInt(toCase.get('j')) === parseInt(fromCase.get('j')) && parseInt(toCase.get('i')) === parseInt(fromCase.get('i') + 3);
          var vertical2 = parseInt(toCase.get('j')) === parseInt(fromCase.get('j')) && parseInt(toCase.get('i')) === parseInt(fromCase.get('i') - 3);
          var diag1 = parseInt(toCase.get('i')) === parseInt(fromCase.get('i') + 2) && parseInt(toCase.get('j')) === parseInt(fromCase.get('j') + 2);
          var diag2 = parseInt(toCase.get('i')) === parseInt(fromCase.get('i') + 2) && parseInt(toCase.get('j')) === parseInt(fromCase.get('j') - 2);
          var diag3 = parseInt(toCase.get('i')) === parseInt(fromCase.get('i') - 2) && parseInt(toCase.get('j')) === parseInt(fromCase.get('j') + 2);
          var diag4 = parseInt(toCase.get('i')) === parseInt(fromCase.get('i') - 2) && parseInt(toCase.get('j')) === parseInt(fromCase.get('j') - 2);
        ...
        isGameOver: function(gameCase){
           var i = parseInt(gameCase.get('i'));
           var j = parseInt(gameCase.get('j'));
